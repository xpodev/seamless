    ...
    def render(self):
        return Div(class_name="container")(
            ...
            Div(class_name="row mt-4")(
                Div(class_name="lead col-12 text-center")("Current counter: ", counter.get()),
            ),
            Div(class_name="row")(
                Div(class_name="col-12 text-center")(
                    Div(class_name="btn-group")(
                        Div(class_name="btn btn-danger", on_click=counter.set("state - 1"))("Decrement"),
                        Div(class_name="btn btn-primary", on_click=counter.set("0"))("Reset"),
                        Div(class_name="btn btn-success", on_click=counter.set("state + 1"))("Increment"),
                    ),
                ),
                Div(class_name="col-12 text-center mt-4")(
                    Form(action="#", on_submit=self.submit)(
                        Input(type="hidden", name="counter_value", value=counter.get()),
